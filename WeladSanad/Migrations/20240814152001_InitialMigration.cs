        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAttends", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentAttends_Attends_AttendId",
                        column: x => x.AttendId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAttends_AttendId",
                table: "StudentAttends",
                column: "AttendId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentAttends_StudentId",
                table: "StudentAttends",
                column: "StudentId");
